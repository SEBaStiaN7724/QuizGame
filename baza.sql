...
CREATE TABLE `answer` (
  ...
  CONSTRAINT `content_id` FOREIGN KEY (`content_id`) REFERENCES `content` (`content_id`)
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wyniki` (
  `idwyniku` int NOT NULL AUTO_INCREMENT,
  `imie_gracza` varchar(100) DEFAULT NULL,
  `punkty` int DEFAULT NULL,
  `data_gry` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dump completed on 2025-12-09 13:47:18
