...
Polimorfizm i Dziedziczenie: Logika poszczególnych trybów gry została wydzielona do osobnych klas (Millionaire, Survival) dziedziczących po głównym silniku gry (GameScreen), co ułatwia rozszerzalność projektu.

Typy wyliczeniowe: Zastosowanie Enum dla kategorii pytań zwiększa czytelność kodu i eliminuje błędy związane z operacjami na ciągach znaków.
